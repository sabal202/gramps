...
class Collateral(Relative):
    ...
    degrees = {
        Person.MALE: [
            ...
            ["одиннадцатиюродный ", "одиннадцатиюродного "],
            ...
            ["двадцатитрехюродный ", "двадцатитрехюродного "],
        ...
        Person.FEMALE: [
            ...
            ["одиннадцатиюродная ", "одиннадцатиюродной "],
            ...
            ["двадцатитрехюродная ", "двадцатитрехюродной "],
    ...
    degrees_plural = [
        ...
        ["одиннадцатиюродные ", "одиннадцатиюродных "],
        ...
        ["двадцатитрехюродные ", "двадцатитрехюродных "],
    ...
    def _get_stereotyped_plural_name(self, genitive=False):
        ...
        try:
            ...
            # RU: (great-)grandparent's siblings shift cousin-degree by +1
            if isinstance(self, Senior) and self.lvl == 2:
                _dgr_idx = self.dgr
            else:
                _dgr_idx = self.dgr - 1
            if _dgr_idx >= len(degrees):
                degree = degrees[-1][genitive]
            else:
                degree = degrees[_dgr_idx][genitive]
...
class Senior(Collateral):
    ...
    def _get_stereotyped_name(self, genitive=False):
        ...
        try:
            ...
            # RU: sibling of a (great-)grandparent => "двоюродный дедушка/бабушка"
            # (Gb=1), "троюродный..." (Gb=2); cousin-degree shifts by +1.
            if self.Ga - self.Gb == 2:
                _deg_idx = self.Gb
            else:
                _deg_idx = self.Gb - 1

            if _deg_idx >= len(degrees):
                degree = degrees[-1][genitive]
            else:
                degree = degrees[_deg_idx][genitive]
